...
:       lda     __CODE_0300_LOAD__-1,x
        ...
        ; Use a fixed BIN target filename so .SYSTEM filename length limits
        ; do not constrain the game binary name.
        ldx     #.strlen("IIMPERIALISM")+1
:       lda     TARGET_NAME,x
        sta     PATHNAME,x
        dex
        bpl     :-
