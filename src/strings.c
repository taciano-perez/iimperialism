...
const char STR_SIR_WE_LACK_RESOURCES[] = "Sir, we lack resources!";
const char STR_MAX_FMT[] = "(max %u)";
const char STR_PER_TURN_MAX_FMT[] = "per turn? (max %u)";
const char STR_TRADER_COST[] = "A trader costs 1 lumber, 1 fabric,";
const char STR_WARSHIP_COST[] = "A frigate costs 1 lumber, 1 fabric,";
